                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 post-list">
                                    ...
                                    <!-- Start Post Area -->
                                        ...
                                        <!-- Single post -->
                                        <div class="card card-body mx-1 px-1 mt-0" style="height: 97%;">
                                            <a href="" class="list-group-item mx-1 px- mt-0" style="background: #1b6d85; color: black; font-family: Symbola;"><strong>Term Dates</strong></a>
                                            @foreach($terms as $term)
                                                        <iframe src="{{ $term->file }}" width="100%" height="98%"></iframe>
