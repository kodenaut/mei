              ...
              ============================-->
                    <div class="row">
                        ...
                        <div class="section-header">
                            <a href="" class="list-group-item text-center" style="background: #265ea1; color: white; font-size: 18px; font-family: Symbola;"><strong>KCSE Past Papers</strong></a>
                        </div>
                        <div class="row mb-3">
                            @foreach($subjects as $subject)
                                <div class="col-sm-2 m-3">
                                    <li style="list-style: none;">
                                        <a href="{{route('papers', $subject->id)}}" style="color: black; font-family: Symbola;"><strong><i class="fas fa-folder-open"></i> {{ $subject->title }}</strong>
                                        </a>
                                    </li>
                                </div>
