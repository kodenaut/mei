    ...
    <section id="messages">
        <div class="container wow fadeIn">
            <div class="section-header">
                <a href="" class="btn btn-outline-info btn-sm float-right" data-toggle="modal" data-target="#statement-add" style="margin: 2px;">Add Tagline
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">New Tagline</h4>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        </div>

                        <!-- Modal body -->
                        <div class="modal-body">
                            <form method="post" action="{{route('save-tag')}}" class="form-control" enctype="multipart/form-data">
                                @csrf
                        ...
                        <article class="media content-section">
                            <div class="media-body">
                                ...
                                <div class="col-sm-12 float-right">
                                    ...
                                    <br>
                                    <form method="post" action="{{route('delete-tag', $info->id)}}" class="form-btn float-right">
                                        @csrf
                    ...
                    <div class="modal" id="update-{{ $info->id }}">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <!-- Modal body -->
                                <div class="modal-body">
                                    <form method="post" action="{{route('update-tag', $info->id)}}" class="form-control" enctype="multipart/form-data">
                                        @csrf
